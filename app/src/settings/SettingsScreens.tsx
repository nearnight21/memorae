...
const styles = StyleSheet.create({
  ...
  primaryButton: { minHeight: 52, borderRadius: 26, backgroundColor: '#43728a', alignItems: 'center', justifyContent: 'center', borderTopWidth: 1, borderTopColor: 'rgba(255, 255, 255, 0.35)', shadowColor: '#2b4d60', shadowOpacity: 0.22, shadowRadius: 10, shadowOffset: { width: 0, height: 4 }, elevation: 4 },
  primaryPressed: { opacity: 0.88, transform: [{ scale: 0.985 }] },
  primaryText: { color: '#f5fbff', fontSize: 15, lineHeight: 22, fontWeight: '600', letterSpacing: 0.5 },
  ...
  editorSave: { color: '#3c667c', fontSize: 14, lineHeight: 20, fontWeight: '600', textAlign: 'right' },
