...
const styles = StyleSheet.create({
  ...
  confirmButton: { minWidth: 58, height: 36, paddingHorizontal: 14, borderRadius: 18, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(235, 245, 250, 0.92)', borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.92)', shadowColor: '#36566b', shadowOpacity: 0.16, shadowRadius: 6, shadowOffset: { width: 0, height: 2 }, elevation: 2 },
  confirmText: { color: '#2e4756', fontSize: 14, fontWeight: '600' },
