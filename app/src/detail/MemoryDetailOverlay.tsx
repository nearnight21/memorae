...
export default function MemoryDetailOverlay({ memory, photoUris, photoStates, onClose, onMore, onPhotoDisplayed, onPhotoPress }: Props) {
      ...
      <View style={styles.safeArea}>
        ...
        <View style={[styles.content, { paddingTop: heroTop }]}>
          {photoCount > 0 && <View style={[styles.photoStage, { width: heroWidth, height: heroHeight }]} {...responder.panHandlers}>
            ...
            <Pressable onPress={() => onPhotoPress(photoIndex)} accessibilityRole="button" accessibilityLabel="查看原图" style={[styles.photoPaper, styles.heroPaper, { width: heroWidth, height: heroHeight }]}>
