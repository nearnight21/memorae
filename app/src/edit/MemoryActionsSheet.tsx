...
const styles = StyleSheet.create({
  ...
  sheet: { position: 'absolute', left: 0, right: 0, bottom: 0, minHeight: 272, paddingHorizontal: 24, paddingTop: 12, paddingBottom: 24, borderTopLeftRadius: 24, borderTopRightRadius: 24, backgroundColor: 'rgba(251, 247, 240, 0.98)', borderTopWidth: 1, borderColor: 'rgba(215, 201, 182, 0.6)', shadowColor: '#2e261c', shadowOpacity: 0.16, shadowRadius: 24, shadowOffset: { width: 0, height: -8 }, elevation: 10 },
  handle: { alignSelf: 'center', width: 34, height: 4, borderRadius: 2, backgroundColor: 'rgba(189, 169, 145, 0.45)' },
  heading: { marginTop: 12, color: '#2d261e', fontSize: 16, lineHeight: 24, fontWeight: '600', textAlign: 'center' },
  ...
  label: { flex: 1, color: '#2d261e', fontSize: 15 },
  dangerLabel: { flex: 1, color: '#8a463b', fontSize: 15 },
  chevron: { color: '#8c7d6b', fontSize: 24, lineHeight: 24 },
  divider: { height: StyleSheet.hairlineWidth, backgroundColor: 'rgba(215, 201, 182, 0.5)' },
  cancelRow: { minHeight: 56, alignItems: 'center', justifyContent: 'center' },
  cancelLabel: { color: '#6e6356', fontSize: 14 },
});
