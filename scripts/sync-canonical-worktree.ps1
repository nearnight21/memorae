...
if ($branch -ne $CanonicalBranch) { throw "Current branch is $branch; expected canonical branch $CanonicalBranch." }
...
Invoke-Git -Arguments @('fetch', '--prune', 'origin', "+refs/heads/${CanonicalBranch}:refs/remotes/origin/$CanonicalBranch")
